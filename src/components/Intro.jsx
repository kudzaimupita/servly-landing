  ...
  return (
    <>
      ...
      <h1 className="mt-14 font-display text-4xl/tight font-light text-white">
        Next-gen Adaptive
        <span className="text-sky-300"> ERP Suite.</span>
      </h1>
      <p className="mt-4 text-sm/6 text-gray-300">
        Our smart ERP engine is your transformational tool. Unify disparate
        processes, achieve heightened efficiency, and navigate your business
        toward success using the intelligence of data-driven insights.
      </p>
      <SignUpForm />
      <div className="mt-8 flex flex-wrap justify-center gap-x-1 gap-y-3 sm:gap-x-2 lg:justify-start">
        ...
        <IconLink
          onClick={() => {
            localStorage.setItem('route', 'features')
        ...
        <IconLink href="/pricing" icon={FeedIcon} className="flex-none">
          Pricing
        </IconLink>
        <IconLink href="/home" icon={FeedIcon} className="flex-none">
          Contact
        </IconLink>
